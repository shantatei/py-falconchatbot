...
from chatHtmlTemplate import css, bot_template, user_template
...
def get_conversation_chain(vectorstore):
    llm = HuggingFaceHub(repo_id="tiiuae/falcon-7b-instruct",model_kwargs={"temperature":0.2,"max_length":1500})
